/**
 * CloudHook - 智能体来源识别
 * 从 /api/hook 请求中识别事件来自 Claude Code / Codex CLI / Antigravity CLI / 其他，
 * 供分类、风险评级、通知文案按来源分支。
 *
 ...
 * @returns {{id: 'claude_code'|'codex'|'antigravity'|'unknown', name: string, source: 'header'|'ua'|'shape'|'fallback'}}
 */
